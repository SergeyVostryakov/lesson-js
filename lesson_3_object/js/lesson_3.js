...
//! нам надо создать свойство обьекта с именем как у переменной (ВАЖНО: Мы можем присвоить любое значение этому свойству) 
...
//     "manufacturer": "ford",//* Значения могут быть разных типов 'ford' String
//     "model": "Mustang Continental Mark II",//! ВАЖНО свойства очень похожи на свойства обьектов но пишутся между двойными кавычками "model": "Mustang Continental Mark II"
//     "engine": {
